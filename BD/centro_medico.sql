...
--
-- Servidor: localhost
-- Tiempo de generación: 23-04-2026 a las 00:59:33
...
--
-- Base de datos: `if0_41713180_centro_medico`
--
...
ALTER TABLE `Medico`
  ...
  ADD UNIQUE KEY `uq_identificacion_medico` (`identificacion_medico`);
...
ALTER TABLE `Paciente`
  ...
  ADD UNIQUE KEY `uq_identificacion_paciente` (`identificacion_paciente`);
...
ALTER TABLE `Usuario`
  ...
  ADD UNIQUE KEY `uq_login_usuario` (`login_usuario`);
